...
--添加菜单
items={"All","Lua","native","rime","Error","Warning","Info","Debug","Verbose","Clear"}
...
func.native=function()
  activity.setTitle("LogCat - native")
  task(readlog,"native:* *:S",show)
end
func.rime=function()
  activity.setTitle("LogCat - rime")
  task(readlog,"rime:* *:S",show)
end
func.Error=function()
